    ...
    <div class="flex h-screen">
        ...
        <div id="sidebar"
            ...
            <nav class="space-y-2"> <a href="#"
                    ...
                    <!-- Home --> <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M3 12l2-2m0 0l7-7 7 7m-9 2v8m0-8h8m-8 0H4" />
                    </svg> <span>Dashboard Admin</span>
                </a> <a href="{{ route('admin.data_karyawan') }}"
                    ...
                    </svg> <span>Absensi dan Cuti</span>
                </a> <a href="#" class="flex items-center space-x-3 px-4 py-2 rounded-lg hover:bg-blue-600 transition">
                    <!-- Dollar --> <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8V4m0 12v4" />
                    </svg> <span>Payroll</span>
                </a> <a href="#" class="flex items-center space-x-3 px-4 py-2 rounded-lg hover:bg-blue-600 transition">
                    <!-- Chart bar --> <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M3 3v18h18M9 17V9m4 8v-5m4 5V5" />
                    </svg> <span>Laporan</span>
                </a> <a href="#" class="flex items-center space-x-3 px-4 py-2 rounded-lg hover:bg-blue-600 transition">
                    <!-- Settings --> <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="flex justify-center mt-4">
                    <form action="{{ route('logout') }}" method="POST" class="inline"> @csrf <button type="submit"
                            class="bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-lg transition"> Logout
                        </button> </form>
                </div>
            </nav>
        </div> <!-- Overlay -->
        ...
        <div class="flex-1 md:ml-64">
            <header class="flex items-center justify-between bg-white p-4 shadow-md">
                <h1 class="text-lg font-semibold">Admin</h1> <button id="menu-btn"
