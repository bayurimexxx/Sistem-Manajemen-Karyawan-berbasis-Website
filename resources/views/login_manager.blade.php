...
<head>
  ...
  <title>Login Manager - Sistem Management Karyawan</title>
...
<body class="relative min-h-screen flex items-center justify-center bg-cover bg-center"
  ...
  <!-- Login Card -->
  <div class="relative z-10 bg-white/10 backdrop-blur-md rounded-xl p-8 w-full max-w-md text-white shadow-lg">
    <h3 class="text-2xl font-bold text-center mb-6 flex items-center justify-center">
      <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-2" fill="currentColor" viewBox="0 0 16 16">
        <path d="M8 0a5 5 0 0 0-5 5v3H2a2 2 0 0 0-2 2v4a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-4a2 2 0 0 0-2-2h-1V5a5 5 0 0 0-5-5zM6 5a2 2 0 1 1 4 0v3H6V5z"/>
      </svg>
      Login Manager                                                                                                         
    </h3>

    <form action="#" method="POST" class="space-y-4">  <!-- Atur router ketika sudah ada halaman dashboard manager -->
      @csrf
      <div>
        <label for="email" class="block text-sm font-medium text-white">Email Manager</label>
