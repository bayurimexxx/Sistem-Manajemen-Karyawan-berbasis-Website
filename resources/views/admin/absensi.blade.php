                ...
                @forelse($absensis as $absensi)
                    <tr>
                        ...
                        <td class="border px-4 py-2 flex space-x-2">
                            <!-- Tombol Edit -->
                            <button onclick="document.getElementById('modal-edit-{{ $absensi->id }}').classList.remove('hidden')" 
                            ...
                            <form action="{{ route('admin.absensi.update', $absensi->id) }}" method="POST">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="keterangan" rows="3"
                                        class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm">{{ $absensi->keterangan }}</textarea>
                                </div>

                                <!-- Tombol Aksi -->
                                <div class="flex justify-end space-x-3">
                                    <button type="button" 
                                        onclick="document.getElementById('modal-edit-{{ $absensi->id }}').classList.add('hidden')" 
